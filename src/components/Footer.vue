...
<div class=" bg-pink-300 ">
    <div class="max-w-2xl mx-auto text-white py-10">
        ...
        <div class="mt-28 flex flex-col md:flex-row md:justify-between items-center text-sm text-white-400">
            <p class="order-2 md:order-1 mt-8 md:mt-0"> &copy; Task App, 2022. </p>
